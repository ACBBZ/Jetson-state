...
class Analyser:
	...
	def model_report(self):
		...
		def power_consumption():
			tempLoadFile5="/sys/bus/i2c/drivers/ina3221x/6-0040/iio:device0/in_power1_input"#CPU POWER
			with open(tempLoadFile5,'r') as tempFile5:
				temp5=tempFile5.read()
			tempLoadFile6="/sys/bus/i2c/drivers/ina3221x/6-0040/iio:device0/in_power2_input"#GPU POWER
			with open(tempLoadFile6,'r') as tempFile6:
				temp6=tempFile6.read()
			tempLoadFile7 = "/sys/bus/i2c/drivers/ina3221x/6-0040/iio:device0/in_power0_input"  # 5v input POWER
			with open(tempLoadFile7, 'r') as tempFile7:
				temp7 = tempFile7.read()
			power_value=float(temp5)+float(temp6)+float(temp7)
			return power_value
